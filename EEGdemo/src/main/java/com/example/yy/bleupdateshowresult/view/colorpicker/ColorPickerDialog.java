...
package com.example.yy.bleupdateshowresult.view.colorpicker;
...
public class ColorPickerDialog
	...
	public static final String TAG = "Main" + ColorPickerDialog.class.getName();
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.button_confirm:
				if (mListener != null && selectedColor!=-1) {
